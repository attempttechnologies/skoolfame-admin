...
import 'package:skoolfame/Screens/Relationship/received_page.dart';
import 'package:skoolfame/Screens/Relationship/sent_page.dart';
import 'package:skoolfame/Utils/app_colors.dart';
import 'package:skoolfame/Widgets/wrapper.dart';

class RelationshipRequest extends StatefulWidget {
  const RelationshipRequest({Key? key}) : super(key: key);

  @override
  State<RelationshipRequest> createState() => _RelationshipRequestState();
}

class _RelationshipRequestState extends State<RelationshipRequest> {
