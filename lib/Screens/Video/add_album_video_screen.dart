...
class AddAlbumVideoScreen extends StatefulWidget {
  const AddAlbumVideoScreen({Key? key}) : super(key: key);

  @override
  _AddAlbumVideoScreenState createState() => _AddAlbumVideoScreenState();
}

class _AddAlbumVideoScreenState extends State<AddAlbumVideoScreen> {
  ...
  void didChangeDependencies() {
    if (ModalRoute.of(context)!.settings.arguments != null) {
      ...
      titleController.text = videoAlbumData.title!;
      descriptionController.text = videoAlbumData.description!;
    }
          ...
          child: Form(
            ...
            child: BlocListener<VideoBloc, VideoState>(
              ...
              listener: (context, state) {
                if (state is AddVideoAlbumSuccessState ||
                    state is EditVideoAlbumSuccessState) {
                      ...
                      MyButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            if (videoAlbumData.sId == null &&
                                albumImage == null) {
                              final SnackBar snackBar = SnackBar(
                                  content:
                                      Text("Please select video cover image"),
                            ...
                            videoAlbumData.sId != null
                                ? videoBloc.add(EditVideoAlbumApiEvent(
                                    params, videoAlbumData.sId!))
                                : videoBloc.add(AddVideoAlbumApiEvent(params));
                          }
                        },
